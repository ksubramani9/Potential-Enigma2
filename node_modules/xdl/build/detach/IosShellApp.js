...
let _configureAndCopyShellAppArchiveAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (args) {
    ...
    if (output) {
      ...
      if (type === 'simulator') {
        yield (0, (_ExponentTools || _load_ExponentTools()).spawnAsync)(`mv ${projectName}.app ${archiveName}.app && tar -czvf ${output} ${archiveName}.app`, null, {
          stdio: 'inherit',
          cwd: appReleasePath,
          shell: true
        });
      } else if (type === 'archive') {
        yield (0, (_ExponentTools || _load_ExponentTools()).spawnAsync)('/bin/mv', [`${projectName}.xcarchive`, output], {
          stdio: 'inherit',
