...
import { MainRoutes, MenuRoutes } from '../../config/navigation/routes';
            ...
            <ScrollView style={styles.container}>
                <View style={styles.section}>
                    ...
                    <View style={styles.row}>
                        <TouchableOpacity style={styles.rowButton} onPress={() => this._navigateAction(MenuRoutes[1])}>
                    ...
                    {/* Email Notifications instead of "push notifs" */}
                    <View style={styles.row}>
                        <RkText rkType='header6'>Email Notifications</RkText>
                        <RkSwitch style={styles.switch}
                                  value={this.state.sendPush}
                                  name="Push"
                                  onValueChange={(sendPush) => this.setState({sendPush})}/>
                        {/* payment settings: are linked to "Refresh button functionality" and have to be changed */}
                    </View>
                    {/* <View style={styles.row}>
                        <RkText rkType='header6'>Payment Method</RkText>
                        <RkSwitch style={styles.switch}
                        ...
                        <View style={styles.row}>
                        <RkText rkType='header7'>History</RkText>
                        <RkSwitch style={styles.switch}
                        value={this.state.getHistory}
                        name="History"
                        onValueChange={(getHistory) => this.setState({getHistory})}/>
                        </View> */}
                </View>
                <View style={styles.section}>
                    <View style={[styles.row, styles.heading]}>
